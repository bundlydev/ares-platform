...
const ModalUsersManagement: FC<ModalProps> = ({ showModal, setShowModal, getListFindName, dataNameSearch }) => {
  ...
  const getRoles = async () => {
    if (!workspaceIam) return;
    const getRolesResult = await workspaceUser.get_roles(); // Replace with the actual method for getting roles
		if ("ok" in getRolesResult) {
